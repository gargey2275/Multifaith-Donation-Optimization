...
function Footer() {
  return (
    <footer>
      <p>
        © 2025 MultiFaith Donation | <Link to="/about">About</Link> |{" "}
        <Link to="/contact">Contact</Link> |{" "}
    ...
    <>
      ...
      >
        <div className="hero-content">
          ...
          <p>
            Optimize your donations across multiple faith-based charities and
        ...
        <div className="circle-container">
          {religions.map((religion) => (
            <div
              key={religion.id}
              className={`circle ${
                selectedReligionId === religion.id ? "active" : ""
              }`}
              onClick={() => setSelectedReligionId(religion.id)}
            >
  ...
  return (
    <div className="about-page-container">
      ...
      <p className="about-intro">
        MultiFaith Donation is dedicated to creating a simple, transparent, and
        impactful way for people to support faith-based charities around the
        world. We believe in the power of collective giving to bring positive
        change.
      </p>
      <div className="about-section">
        <h3>Our Mission</h3>
        <p>
          Our mission is to bridge the gap between donors and deserving causes,
          ensuring that every contribution is meaningful. We aim to foster a
          community of givers who are passionate about supporting spiritual and
      ...
      <div className="about-section">
        <h3>How It Works</h3>
        <p>
          1. <strong>Discover Causes:</strong> Browse through a curated list of
          causes associated with different faiths.
          <br />
          2. <strong>Learn More:</strong> Get detailed information about each
          project, its goals, and its impact.
          <br />
          3. <strong>Donate with Confidence:</strong> Contribute directly to the
          causes you care about through our secure platform.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="contact-page-container">
      ...
      <div className="contact-details">
        ...
        <p>
          <strong>Email:</strong>{" "}
          <a href="mailto:mahajangargey8@gmail.com">mahajangargey8@gmail.com</a>
        </p>
        <p>
            ...
            <div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input type="text" id="expiry" placeholder="08/28" />
                </div>
                <div className="form-group">
          ...
          {paymentMethod === "netbanking" && (
            <div>
              <div className="form-group">
                ...
                <select id="bank-select" className="bank-select">
            ...
            <Route
              ...
              element={
                <div style={{ padding: "50px" }}>
                  <h1>Privacy Policy Page Coming Soon!</h1>
                </div>
              }
            />
            <Route
